...
class TaskRow(ctk.CTkFrame):  # type: ignore
    ...
    def __init__(
        ...
        Args:
            ...
            task_text (str): Description of the task.
            completed (bool): Whether the task is completed.
            on_toggle (Callable[[int], None]): Callback for toggling completion.
            on_delete (Callable[[int], None]): Callback for deleting a task.
        """
...
class TaskApp(ctk.CTk):  # type: ignore
    ...
    def setup_ui(self) -> None:
        ...
        ctk.CTkButton(
            input_frame, text="➕ Add Task", width=120, command=self.add_task_event
    ...
    def add_task_event(self, event: Optional[Any] = None) -> None:
        ...
        Args:
            event (Optional[Any]): The event object.
        """
