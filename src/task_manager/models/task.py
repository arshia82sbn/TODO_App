...
class TaskFactory:
    ...
    # Rationale: Centralizing task creation allows for easier extensions (e.g., adding sub-types)
    # and simplifies testing by providing a single point of entry for Task instantiation.
    """
